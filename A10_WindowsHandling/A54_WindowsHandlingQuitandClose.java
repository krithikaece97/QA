...
public class A54_WindowsHandlingQuitandClose {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Set<String> windowhandle = wd.getWindowHandles();// getwindowhandle returntype is set<string>
		...
		//wd.quit();//it ill close the entire window
		wd.close();//it ill close the current window
		
		
		
		//this part will again switch into a another window
		wd.switchTo().window(parent);
		String text1 = wd.getTitle();
