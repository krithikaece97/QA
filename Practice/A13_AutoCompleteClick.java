...
public class A13_AutoCompleteClick {
	...
	public static void main(String[] args) {
		...
		WebElement tag = wd.findElement(By.id("tags1"));
		tag.sendKeys("a");
		List<WebElement> tags1 = wd.findElements(By.xpath("//*[@id=\"ui-id-3\"]/li"));
		System.out.println("hi");
		System.out.println(tags1.size());
		for(int i=0;i<tags1.size();i++)
		{
			String text = tags1.get(i).getText();
