...
public class A36_JavaSelectByVisibleText {
	...
	public static void main(String[] args) {
		...
		{
			String text = options.get(i).getText();//text will store all data(options) 
			if(text.equals("Chennai"))//it checks all the data which is matching chennai
			{
				options.get(i).click();// then it ill click that chennai option
			}
